...
echo "#eeeeee";} ?>
        ...
        .social img{height: 32px;width: 100%}
                                                ...
                                                <li>
                                                    <div class="promo_cont <?=$classg?> <?=$classp?>">
                                                        ...
                                                        <div class="promos_data">
                                                            ...
                                                            <?php }else{ ?>
                                                                <p class="promo_fecha"><span class="promo_finicio">Desde: <span class="promo_date">-</span></span> <span class="promo_ffin font-weight-bold">Hasta: <span class="promo_date">-</span></span></p>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                </li>
                    ...
                    <?php if(isset($cmapa))  { ?>
                        <div class="box-cont">
                            ...
                            <div class="panel">
                                ...
                                <div class="map_goo">
                                    <a href="https://www.google.com/maps/dir/Current+Location/<?=$clat?>,<?=$clng?>" class="lleg"> <i class="fas fa-location-arrow"></i> Cómo llegar  </a>
                                </div>
                            </div>
                            ...
                            <div class="panel">
                                <div id="content_qr">
                                    <div class="ratio-box fade-box tamqr">
                                        <img src="https://www.boliviaentusmanos.com/imagenes/betm.jpg" data-src="/amarillas/qr/<?= $codigo_qr ?>" title="QR para compartir Tarjeta <?=$nombre?>" alt="Código QR <?=$nombre?>" class="img_qr lazyload blur-up">
                                    </div>
                                </div>
                            </div>
                        </div>
